	...
	return (
		<Layout>
			<h1 className="text-3xl font-bold mt-8 text-center">
				Learn <NextLogo className="inline-block w-32 mx-2 my-1 text-white" /> by
				doing
			</h1>
			<p className="text-sm italic text-gray-200">
				"learn by doing" is the best way to learn
			</p>
			<p className="font-mono text-lg mt-3">"doing.... what!?", you ask?</p>
			<motion.div
			...
			<Link href="/challenges/1">
				<motion.a
					...
					onHoverStart={() => setButtonVariant("hover")}
